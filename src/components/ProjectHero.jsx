...
const ProjectHero = ({ title, image, imageAlt }) => {
  return (
    <>
      {/* Project Title */}
      <div className="flex flex-row items-start justify-start gap-1 mb-8 pl-0 mt-8 sm:mt-0">
      ...
      <div className="w-full mb-8 sm:mb-12 lg:mb-16">
        <div className="relative w-[calc(100%-1rem)] lg:w-full overflow-hidden bg-[#FFF7F2]">
