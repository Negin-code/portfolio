...
const AnimatedThreads = () => {
  ...
  return (
    <section
      className="col-span-full relative mt-10 w-full h-32 md:h-40 lg:h-48 overflow-hidden"
      aria-label="Decorative animated threads background"
      role="img"
      aria-hidden="true"
    >
        ...
        <div className="relative w-full max-w-7xl h-full">
          ...
          >
            ...
            <path
              ...
              opacity="0.2"
              className={
                prefersReducedMotion ? "" : "animate-pulse animation-delay-200"
              }
              style={{
                transform: prefersReducedMotion
                  ? "translateY(0px)"
            ...
            <path
              ...
              opacity="0.2"
              className={
                prefersReducedMotion ? "" : "animate-pulse animation-delay-400"
              }
              style={{
                transform: prefersReducedMotion
                  ? "translateY(0px)"
            ...
            <path
              ...
              style={{
                transform: prefersReducedMotion
                  ...
                  : `translateY(${mousePosition.y * 5}px) translateX(${
                      mousePosition.x * 10
                    }px)`,
                transformOrigin: "center",
              }}
            ...
            <div
              ...
              className={`absolute ${dot.size} ${dot.color} rounded-full ${
                prefersReducedMotion
                  ? ""
                  : `animate-pulse ${
                      dot.delay ? `animation-delay-${dot.delay}` : ""
                    }`
              }`}
              style={{
                transform: prefersReducedMotion
                  ? "translateY(-50%)"
                  : `translate(${mousePosition.x * dot.x}px, ${
                      mousePosition.y * dot.y
                    }px) translateY(-50%)`,
                transition: prefersReducedMotion
                  ? "none"
                  : "transform 0.3s ease-out",
