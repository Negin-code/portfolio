...
const ListeningLab = () => {
  ...
  return (
    <main
      id="top"
      className="grid grid-cols-4 sm:grid-cols-4 md:grid-cols-6 lg:grid-cols-12 gap-4 min-h-screen bg-[#FFF7F2] pt-20 lg:pt-50 lg:px-0 md:px-8 relative overflow-hidden"
    >
      {/* Decorative elements - purely visual */}
      <div
        className="absolute left-17 md:left-20 top-0 bottom-8 h-[calc(100%-10rem)] w-[2px] bg-[#493b32]"
        aria-hidden="true"
      ></div>
      <div
        className="absolute right-10 top-0 bottom-8 h-[calc(100%-10rem)] w-[2px] bg-[#493b32]"
        aria-hidden="true"
      ></div>

      {/* Project Header */}
      <header className="col-span-4 sm:col-span-4 md:col-span-6 lg:col-span-10 lg:col-start-2 flex flex-row items-start justify-start gap-1 px-20 pt-15 sm:pt-25 lg:pt-0">
        <div
          className="w-[4vh] sm:w-[5vh] md:w-[7vh] h-[2px] bg-[#493B32] mt-4"
          aria-hidden="true"
        ></div>
      ...
      <div className="col-span-4 col-start-1 sm:col-span-4 sm:col-start-1 md:col-span-6 lg:col-span-10 lg:col-start-2 pl-20">
        ...
        >
          <h2 id="project-preview" className="sr-only">
            Project Preview and Information
          </h2>

          {/* Image Slider Section */}
          <div className="lg:col-span-7">
            <figure className="rounded-md overflow-hidden bg-[#FFF7F2] relative">
          ...
          <aside className="lg:col-span-5 space-y-6">
            <div
              className="bg-[#5E3F27] text-[#FFF7F2] text-md sm:text-lg font-medium rounded-sm px-4 py-1 mb-4 w-fit flex justify-start items-start"
              role="note"
            >
              Service Design
            </div>
            <hr className="border-t border-[#493B32]" />
            ...
            <div>
              <h4 className="sr-only">Tools and Technologies Used</h4>
              <ul
                className="flex flex-wrap gap-2 mt-4 text-[#493B32]"
                role="list"
              >
                <li className="border border-[#493B32] px-3 py-1 text-[#493B32]">
                  Zoom
                </li>
                <li className="border border-[#493B32] px-3 py-1 text-[#493B32]">
                  Miro
        ...
        <section className="mb-16" aria-labelledby="project-journey">
          <h2
            id="project-journey"
            className="text-3xl font-tan text-[#493B32] mb-10"
          >
            Project Journey
          </h2>
            ...
            <VerticalTimeline lineColor="#493B32">
              ...
              >
                <h3 className="text-xl font-semibold text-[#493B32] mb-2">
                  Listening Lab 01: User Research and Initial Exploration
                </h3>
                <p className="text-[#493B32]">
                  The first iteration, Listening Lab 01, focused on
                  understanding the role of listening in building trust,
                  fostering empathy, and addressing cultural nuances. Through
                  qualitative research, workshops, and feedback sessions, we
                  explored challenges such as cultural biases, time constraints,
                  and the lack of active listening in staff-client interactions.
                  The Lab introduced concepts like "inner and outer listening,"
                  reflective exercises, and cultural discussions, helping
                  participants recognize listening as an act of generosity and
                  connection rather than a task-focused activity.
                </p>
              </VerticalTimelineElement>
              ...
              >
                <h3 className="text-xl font-semibold text-[#493B32] mb-2">
                  Listening Lab 02: Iterative Design and Refinement
                </h3>
                <p className="text-[#493B32]">
                  Building on the insights and feedback from the first Lab,
                  Listening Lab 02 aimed to refine the approach and deepen the
                  exploration of cultural nuances in listening. This second
                  iteration included both online and in-person workshops,
                  featuring interactive elements like cultural moment
                  presentations, reflective activities, and discussions on
                  high-context versus low-context communication. Participants
                  were encouraged to share personal stories, enhancing cultural
              ...
              >
                ...
                <p className="text-[#493B32]">
                  One of the most rewarding aspects of this project was the
                  impact it had on participants. Staff reported increased
                  awareness of their listening habits and a deeper appreciation
                  for listening as an act of connection and generosity. The
                  workshops also sparked curiosity about culturally informed
                  listening practices, with participants expressing interest in
                  tangible tools to navigate these nuances effectively.
                </p>
              </VerticalTimelineElement>
              ...
              >
                ...
                <p className="text-[#493B32]">
                  This project taught me the importance of creating safe spaces
                  for dialogue and collaboration, especially when addressing
                  sensitive topics like cultural differences. It reinforced my
                  belief that listening is not just a skill but a powerful tool
                  for building trust and fostering inclusion. Moving forward, I
                  aim to refine the Listening Lab further, expanding its reach
                  to other organizations and continuing to explore the
